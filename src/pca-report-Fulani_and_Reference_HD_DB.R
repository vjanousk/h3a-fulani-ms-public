#########################################################################
# Functions for PCA report (pca-report-Fulani_and_Reference_HD_DB.Rmd)
...
jpeg("src/rmd-reports/pca-report-Fulani_and_Reference_HD_DB/pca-eigen-value-Fulani_and_Reference_HD_DB.jpg",
...
jpeg("src/rmd-reports/pca-report-Fulani_and_Reference_HD_DB/pca-pc1-pc2.jpg",
...
jpeg("src/rmd-reports/pca-report-Fulani_and_Reference_HD_DB/pca-pc1-pc3.jpg",
     units="in",width = 8, height = 5, res = 300, quality=100)
p
dev.off()
...
jpeg("src/rmd-reports/pca-report-Fulani_and_Reference_HD_DB/pca-pc2-pc3.jpg",
     units="in",width = 8, height = 5, res = 300, quality=100)
p
dev.off()
